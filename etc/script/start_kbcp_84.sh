...
find_java_svr_pid
kill_java_svr
nohup java -jar -server -Xmx5g -XX:+UseG1GC -Djava.awt.headless=true -Dspring.profiles.active=prod -Dsvr.nm=PRDD_KBCP_84 -Dfile.encoding=UTF-8 KBCoupon.jar 1> /dev/null 2>&1 &
